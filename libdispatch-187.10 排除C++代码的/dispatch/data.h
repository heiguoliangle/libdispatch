...
dispatch_data_t
dispatch_data_create_concat(dispatch_data_t data1, dispatch_data_t data2);// concat: 串联,合并
 ...
 * in logical order and invoke the specified block once for every contiguous(连续的)
 * memory region encountered(遭遇,遇到).
 *
